...
class AppLockService : AccessibilityService() {
    ...
    private val BLOCK_DEBOUNCE_MS = 1000L // 1 second debounce

    override fun onServiceConnected() {
        super.onServiceConnected()
        Log.d(TAG, "AppLockService connected")

        // Reinforce configuration programmatically for reliability
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (packageName in lockedPackages) {
            ...
            // Debounce to prevent rapid-fire blocking
            ...
            // 1. Press Back immediately to dismiss the blocked app
