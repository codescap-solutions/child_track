...
class SubscriptionData {
  static const List<SubscriptionPlan> plans = [
    SubscriptionPlan(
      ...
      monthlyPrice: 499,
      yearlyPrice: 4999,
      yearlyDiscountBadge: 'Save 17%',
      ctaText: 'Choose Premium',
      features: [
        SubscriptionFeature(name: 'Real-Time Tracking'),
        SubscriptionFeature(name: '10 Geofence Zones'),
        SubscriptionFeature(name: '5 Parent / Guardian Logins'),
        SubscriptionFeature(name: '30 Days Location History'),
        SubscriptionFeature(name: 'SOS Alerts'),
        SubscriptionFeature(name: 'Battery Alerts'),
        SubscriptionFeature(name: 'Route Playback'),
        SubscriptionFeature(name: 'School Arrival Notifications'),
        SubscriptionFeature(name: 'AI Safety Insights'),
        SubscriptionFeature(name: 'Advanced Family Dashboard'),
        SubscriptionFeature(name: 'Premium Customer Support'),
        SubscriptionFeature(name: 'App Controls'),
      ],
    ),
    SubscriptionPlan(
      id: 'smart',
      ...
      features: [
        SubscriptionFeature(name: 'Real-Time Tracking'),
        SubscriptionFeature(name: '7 Geofence Zones'),
        SubscriptionFeature(name: '3 Parent / Guardian Logins'),
        SubscriptionFeature(name: '15 Days Location History'),
        SubscriptionFeature(name: 'SOS Alerts'),
        SubscriptionFeature(name: 'Battery Alerts'),
        SubscriptionFeature(name: 'Device Offline Alerts'),
        SubscriptionFeature(name: 'Route Playback'),
        SubscriptionFeature(name: 'Priority Support'),
      ],
    ),
    SubscriptionPlan(
      id: 'basic',
      ...
      monthlyPrice: 199,
      yearlyPrice: 1999,
      yearlyDiscountBadge: 'Save 16%',
      ctaText: 'Choose Basic',
      features: [
        SubscriptionFeature(name: 'Real-Time Tracking'),
        SubscriptionFeature(name: '3 Geofence Zones'),
        SubscriptionFeature(name: '2 Parent / Guardian Logins'),
        SubscriptionFeature(name: '3 Days Location History'),
        SubscriptionFeature(name: 'SOS Alerts'),
        SubscriptionFeature(name: 'Low Battery Alerts'),
        SubscriptionFeature(name: 'Device Offline Alerts'),
      ],
    ),
    SubscriptionPlan(
      id: 'starter',
      name: 'FREE',
      tagline: 'The smart recommendation is the plan we tailored for you',
      monthlyPrice: 0,
      ctaText: 'Choose Starter',
      features: [
        SubscriptionFeature(name: 'Real-Time Tracking'),
        SubscriptionFeature(name: '1 Geofence Zone'),
        SubscriptionFeature(name: '1 Parent Access Login'),
        SubscriptionFeature(name: '24-Hour Location History'),
        SubscriptionFeature(name: 'SOS Alert'),
      ],
    ),
  ];
}
