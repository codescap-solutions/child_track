...
class _TripDetailViewState extends State<TripDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    final bottomSheetHeight = screenHeight * 0.4; // 40% of screen height
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          _buildMapSection(context, widget.markers, widget.polylines),

          // Bottom Container with Trip Timeline
          Positioned(
            left: 0,
            right: 0,
            bottom: 0,
                ...
                if (icon == Icons.home)
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.trip.type.toUpperCase()),
                        Text(
                        ...
                        Container(
                          ...
                          child: Text(
                            'max speed - ${widget.trip.maxSpeedKmph} kmp',
                            style: AppTextStyles.caption.copyWith(
                              color: AppColors.primaryColor,
                              fontWeight: FontWeight.w600,
                            ),
